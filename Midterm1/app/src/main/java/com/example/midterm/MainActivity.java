...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateOutput(TextView lblOutput) {
        ...
        if (boy.isChecked())
            outputStr.append(getResources().getString(R.string.male) + "\n");
        else if (girl.isChecked())
            outputStr.append(getResources().getString(R.string.female) + "\n");
        ...
        if (type.getCheckedRadioButtonId() == R.id.rdbAdult) {
            outputStr.append(getResources().getString(R.string.regularticket) + "\n");
            price = 500;
        } else if (type.getCheckedRadioButtonId() == R.id.rdbChild) {
            outputStr.append(getResources().getString(R.string.childticket) + "\n");
            price = 250;
        } else if (type.getCheckedRadioButtonId() == R.id.rdbStudent) {
            outputStr.append(getResources().getString(R.string.studentticket) + "\n");
            price = 400;
        }
        ...
        if (!numStr.isEmpty()) {
            ...
            outputStr.append(getResources().getString(R.string.total)).append(num * price);
